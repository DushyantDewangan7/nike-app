      ...
      <div className="relative xl:w-2/5
       flex flex-col justify-center
        items-start w-full max-xl:padding-x pt-28">
          <p className=" text-xl font-montserrat px-3 text-coral-red">
          ...
          <p className=" font-montserrat text-slate-500 text-lg leading-8 mt-6 mb-14
           sm:max-w-sm">Discover stylish nike Shoes
            ,qualities comfort 
