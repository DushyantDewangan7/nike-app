    ...
    <footer className="max-container">
      ...
      flex-wrap max-lg:flex-col">
          <div className="flex flex-col items-start">
            ...
            <p className="mt-6 leading-7 text-base font-montserrat text-white-400 max-w-sm">Lorem ipsum dolor sit amet, consectetur adipisicing elit.
               Officia obcaecati ullam distinctio nemo ut veniam necessitatibus voluptate, 
              iste quos laudantium quasi beatae debitis 
              alias consequuntur vitae repudiandae illum repellendus aliquam!</p>
                  ...
                  <div key={section}>
                      ...
                      <ul>
                        {section.links.map((link)=>(
                          <li className="mt-3 text-white-400 font-montserrat text-base leading-normal text-slate-gray
                            ...
                            <div className="flex justify-between text-white-400 mt-24 max-sm:flex-col
                             max-sm:items-center">
                              <div className=" flex flex-1 justify-start gap-2 font-montserrat cursor-pointer ">
                                ...
                                <p>Copyrigghts all raights reserved.</p>
                              </div>
